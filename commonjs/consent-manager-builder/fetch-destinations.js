...
function fetchDestinationForWriteKey(cdnHost, writeKey) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, isomorphic_fetch_1.default)("https://".concat(cdnHost, "/v1/projects/").concat(writeKey, "/integrations"))];
                case 1:
                    res = _a.sent();
                    if (!res.ok) {
                        throw new Error("Failed to fetch integrations for write key ".concat(writeKey, ": HTTP ").concat(res.status, " ").concat(res.statusText));
                    }
